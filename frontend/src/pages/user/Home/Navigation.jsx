        ...
        {menuOpen && !isLoggedIn && (
          <div className="md:hidden flex flex-col gap-2 px-4 py-3 bg-card border-t border-border shadow-lg animate-in fade-in-0 slide-in-from-top-2 rounded-b-lg">
            ...
            <div className="mt-2 flex flex-col gap-2">
              <Button variant="ghost" className="justify-start w-full" onClick={() => {setMenuOpen(false); navigate('/problems')}}>
                Problems
              </Button>
              <Button variant="ghost" className="justify-start w-full" onClick={() => {setMenuOpen(false); navigate('/interview')}}>
                Interview
              </Button>
