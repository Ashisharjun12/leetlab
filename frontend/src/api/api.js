...
export const playlistAPI = {   
    ...
    getPlaylistDetails: (playlistId) => axiosInstance.get(`/playlist/${playlistId}`),
    deletePlaylist: (playlistId) => axiosInstance.delete(`/playlist/${playlistId}`),
    ...
    removeProblemFromPlaylist: (playlistId, problemIds) => 
        axiosInstance.delete(`/playlist/${playlistId}/remove-problem`, { data: { problemIds } })
}

// Submission API endpoints
export const submissionAPI = {
  getAllSubmissions: () => axiosInstance.get('/submission'),
  getSubmissionsForProblem: (problemId) => axiosInstance.get(`/submission/get-submission/${problemId}`),
  getAllTheSubmissionsForProblem: (problemId) => axiosInstance.get(`/submission/get-submission-for-count/${problemId}`),
}
